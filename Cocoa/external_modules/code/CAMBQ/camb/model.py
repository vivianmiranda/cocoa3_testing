...
class CAMBparams(F2003Class):
    ...
    _fields_ = [
        ...
        ("which_potential",c_int,"potential type"),
        ("potentialparameter1",c_double,"potential parameter 1"),
        ("potentialparameter2",c_double,"potential parameter 2"),
        ("want_binary_search",c_bool,"deciding if we want or not to do binary search on potential parameter 1"),
    ...
    def set_cosmology(self, H0: Optional[float] = None, ombh2=0.022, omch2=0.12, omk=0.0,
                      which_potential=1,
                      potentialparameter1=1.0, potentialparameter2=1.0, want_binary_search=True,
        ...
        self.want_binary_search = want_binary_search
        # DHFS: Ends my parameters
        if omnuh2_sterile > 0:
