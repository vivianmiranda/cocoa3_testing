...
One model evaluation:
        ...
        $(cocoapy38)(.local) $COCOA_RUN_EVALUATE ./projects/example/EXAMPLE_EVALUATE1.yaml -f
...
MCMC:
        ...
        $(cocoapy38)(.local) export NTASKS=4
        $(cocoapy38)(.local) $COCOA_RUN_MCMC ./projects/example/EXAMPLE_MCMC1.yaml -f
